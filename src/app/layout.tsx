...
const runtimeFlags = {
  ...
  OPERATIONS_OVERVIEW: process.env.OPERATIONS_OVERVIEW,
  OPERATIONS_APPROVALS: process.env.OPERATIONS_APPROVALS,
  OPERATIONS_AGENTS: process.env.OPERATIONS_AGENTS,
  OPERATIONS_CONNECTORS: process.env.OPERATIONS_CONNECTORS,
